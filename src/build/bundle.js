...
/***/ function(module, exports, __webpack_require__) {
	...
	var bdd = [];
	var p1 = new def.User("PH");
	var p2 = new def.User("Benjamin");
	var p3 = new def.User("Alexandre");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Definition_3 = __webpack_require__(1);
	function rateMovie(rater, movie, score) {
	    return new Definition_3.RatedMovie(movie.title, movie.genres, movie.criteria, rater, score);
	}
	...
	*/
	...
	function addNewRatedMovie(bdd, rater, movie, score) {
	    bdd.push(new Definition_3.RatedMovie(movie.title, movie.genres, movie.criteria, rater, score));
