...
/***/ function(module, exports, __webpack_require__) {
	...
	var arg = __webpack_require__(1);
	// Some samples to test
	console.log("Les utilisateurs:");
	var ph = new def.User("PH");
	var kribouille = new def.User("Benjamin");
	var thain = new def.User("Alexandre");
	var bastien = new def.User("Bastien");
	console.log(ph);
	console.log(kribouille);
	console.log(thain);
	console.log(bastien);
	console.log("Les films:");
	var ingloriousBasterds = new def.Movie("Inglorious Basterds", ["action", "drama"], ["c1", "c2", "c3", "c4", "c5"]);
	var djangoUnchained = new def.Movie("Django Unchained", ["action", "comedy"], ["c1", "c2", "c3", "c4", "c5"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Definition_1 = __webpack_require__(2);
